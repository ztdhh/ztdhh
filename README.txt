...
proxies:
  ...
  - name: Youtube顺丰资源 CN80
    ...
    skip-cert-verify: true
    udp: true
  - name: 新加坡-410.7KB/s(Youtube:不良林)
    server: 152.69.221.20
    port: 80
    type: vmess
    uuid: bd1928f2-0818-4192-d14a-0961f05c0fdf
    alterId: 0
    cipher: auto
    tls: false
    skip-cert-verify: true
  ...
  - name: Youtube顺丰资源 CN__59
    ...
    skip-cert-verify: true
    udp: true
  - name: Youtube顺丰资源+CN81
    server: cm3.naichald.xyz
    port: 38878
    type: ss
    cipher: chacha20-ietf-poly1305
    password: 1529dad3-c7ff-4873-a95c-ab219a72e5de
    udp: true
  ...
  - name: Youtube顺丰资源 CN209
    ...
    skip-cert-verify: true
    udp: true
  - name: 中转节点-19.38MB/s(Youtube:不良林)
    server: vachyrh.wndtkn.xyz
    port: 9300
    type: ss
    ...
    plugin-opts:
      mode: http
      host: 39144-B3ms6lwiXRiRtwR.download.microsoft.com
    udp: true
  ...
  - name: 中转节点-6.67MB/s(Youtube:不良林)
    ...
    udp: true
  - name: 中转节点-7.57MB/s(Youtube:不良林)
    server: edge-mars.themars.top
    port: 50002
    type: ss
    cipher: chacha20-ietf-poly1305
    password: e5fbb896-cf74-44f5-90ae-b3333e1d3ca0
    udp: true
  - name: 中转节点-6.55MB/s(Youtube:不良林)
    ...
    udp: true
  - name: 中转节点-7.18MB/s(Youtube:不良林)
    server: edge-mars.themars.top
    port: 50013
    type: ss
    cipher: chacha20-ietf-poly1305
...
proxy-groups:
  - name: 🔰 节点选择
    ...
    proxies:
      ...
      - Youtube顺丰资源 美国
      - Youtube顺丰资源 CN209
      - 中转节点-19.38MB/s(Youtube:不良林)
      - 新加坡-1.66MB/s(Youtube:不良林)
      - 中转节点-6.67MB/s(Youtube:不良林)
      - 中转节点-7.57MB/s(Youtube:不良林)
      - 中转节点-6.55MB/s(Youtube:不良林)
      - 中转节点-7.18MB/s(Youtube:不良林)
  - name: ♻️ 自动选择
    type: url-test

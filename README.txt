    ...
    http-opts:
      ...
      headers:
        Host:
          - 8.218.122.246
    udp: true
  - name: 中转节点-513.8KB/s(Youtube:不良林)
    server: 183.60.211.69
    port: 6017
    type: ssr
    cipher: rc4-md5
    password: di15PV
    protocol: auth_aes128_md5
    obfs: plain
    protocol-param: 87742:F8DN43HF7SADH438
    obfs-param: ""
    udp: true
  - name: 中转节点-14.63MB/s(Youtube:不良林)
    server: 36.138.255.130
    port: 3202
    type: ssr
    cipher: rc4-md5
    password: di15PV
...
proxy-groups:
  - name: 🔰 节点选择
    ...
    proxies:
      ...
      - 中转节点-513.8KB/s(Youtube:不良林)
      - 中转节点-14.63MB/s(Youtube:不良林)
  - name: ♻️ 自动选择
    type: url-test

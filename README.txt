    ...
    http-opts:
      ...
      headers:
        Host:
          - 43.129.234.80
    udp: true
  - name: 香港-4.17MB/s(Youtube:不良林)
    server: 8.210.95.105
    port: 24514
    type: vmess
    uuid: 9174e354-21e9-49b3-8d3c-079e0dd6c879
    alterId: 0
    cipher: auto
    tls: false
    skip-cert-verify: true
    ...
    http-opts:
      ...
      headers:
        Host:
          - 8.218.122.246
    udp: true
  - name: 香港-3.00MB/s(Youtube:不良林)
    server: 8.218.97.196
    port: 58300
    type: vmess
    uuid: af2aa6a2-6350-454f-8b91-a25fd65b9ab0
    alterId: 0
    cipher: auto
    tls: false
    skip-cert-verify: true
...
proxy-groups:
  - name: 🔰 节点选择
    ...
    proxies:
      ...
      - 香港-4.17MB/s(Youtube:不良林)
      - 中转节点-5.33MB/s(Youtube:不良林)
      - 香港-1.32MB/s(Youtube:不良林)
      - 香港-3.00MB/s(Youtube:不良林)

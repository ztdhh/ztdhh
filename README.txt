...
proxies:
  ...
  - name: 中转节点-5.66MB/s
    ...
    port: 39037
    type: vmess
    uuid: 73bd4b21-cb96-3a72-95c9-f65e2584654e
    alterId: 0
    cipher: auto
    tls: false
  ...
  - name: 德国高速入口(频道:马克吐温)
    ...
    port: 443
    type: trojan
    password: b3b0f232-905d-49a8-a2a5-562acad8ef99
    skip-cert-verify: true
    udp: true
  - name: Youtube顺丰资源 美国79
  ...
  - name: 美国-2.78MB/s 2
    ...
    udp: true
  - name: Youtube顺丰资源 GB147
    server: 51.141.11.92
    port: 33131
    type: ss
    cipher: chacha20-ietf-poly1305
    password: ujbow8ZY46sUMEqvGfh7BT
    udp: true
  - name: 中转节点-1.44MB/s
    server: 120.233.43.62
    port: 51904
    type: vmess
    uuid: 418048af-a293-4b99-9b0c-98ca3580dd24
    alterId: 64
  ...
  - name: 美国-2.57MB/s(Youtube:不良林)
    ...
    udp: true
  - name: 台湾高速入口(频道:马克吐温)
    server: hinet1.downloadvip.cfd
    port: 443
    type: trojan
    password: b3b0f232-905d-49a8-a2a5-562acad8ef99
    sni: hinet1.downloadvip.cfd
    skip-cert-verify: true
    udp: true
proxy-groups:
  - name: 🔰 节点选择

...
proxies:
  ...
  - name: Youtube顺丰资源 HK 3
    ...
    skip-cert-verify: true
    udp: true
  - name: 中转节点-4.82MB/s(Youtube:不良林)
    ...
    plugin-opts:
      mode: http
      host: fe31c9e27ce6.microsoft.com
    udp: true

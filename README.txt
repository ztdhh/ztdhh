...
proxies:
  ...
  - name: Youtube顺丰资源 CN__59
    server: cs.guanguan.club
    port: 41406
    type: vmess
    uuid: 6cde68e5-59bf-4ed8-b110-b9464dfa3826
    alterId: 0
    cipher: auto
    tls: false
    skip-cert-verify: true
    ...
    ws-path: /
    ws-headers:
      Host: cs.guanguan.club
    udp: true
  - name: Youtube顺丰资源 江苏省南京市 小鸟云联通

...
proxies:
  - name: 日本-5.50MB/s(Youtube:不良林)
    server: 168.138.44.176
    port: 443
    type: trojan
    password: 8d2d5953-d649-4034-94f2-72f2df2623da
  ...
  - name: 法国-324.4KB/s(Youtube:不良林)
    ...
    skip-cert-verify: true
    udp: true
  - name: 美国-4.85MB/s(Youtube:不良林)
    server: 129.146.190.42
    port: 443
    type: trojan
    password: dbf9bf9c-2c3f-474a-8031-d4c00666a989
    skip-cert-verify: true
    udp: true
  - name: 未知国家-4.69MB/s(Youtube:不良林)
    ...
    ws-headers:
      Host: guil.tk
    udp: true
  - name: 荷兰-1.08MB/s(Youtube:不良林)
    server: content-provider23.cdn-delivery.akamaicd.com
    port: 443
    type: trojan
    password: Sp3eDVp
    sni: content-provider23.cdn-delivery.akamaicd.com
    skip-cert-verify: true
    udp: true
  - name: 荷兰-3.30MB/s(Youtube:不良林)
    server: content-provider24.cdn-delivery.akamaicd.com
    port: 443
    type: trojan
    password: Sp3eDVp
    sni: content-provider24.cdn-delivery.akamaicd.com
    skip-cert-verify: true
    udp: true
  - name: 中转节点-4.47MB/s(Youtube:不良林)
    server: 7ufo9x9pcm.kuaiisou.xyz
    port: 12732
    type: ss
    cipher: aes-128-gcm
    ...
    plugin-opts:
      mode: http
      host: 966970ea494d.microsoft.com
    udp: true
  - name: 中转节点-1.90MB/s(Youtube:不良林)
    server: shzz.ikuncloud.com
    port: 16009
    type: ss
    cipher: chacha20-ietf-poly1305
    password: 7ae36204-cc10-4e6d-8ef2-799df142bb99
    udp: true
  - name: 中转节点-9.78MB/s(Youtube:不良林)
    ...
    skip-cert-verify: true
    udp: true
  - name: 美国-2.24MB/s(Youtube:不良林)
    server: 23.237.33.106
    port: 443
    type: vmess
    ...
    udp: true
  - name: 越南-842.0KB/s(Youtube:不良林)
    server: yn.xbywwcp.us
    port: 25025
    type: vmess
    uuid: 8effdbce-8e1d-4a3c-a97d-d07ac31993be
    alterId: 0
    cipher: auto
    tls: false
    skip-cert-verify: true
    network: ws
    ws-path: /qingzhuanduoyun
    ws-headers:
      Host: a.189.cn
    udp: true
  - name: 澳门-6.11MB/s(Youtube:不良林)
    server: mac.loc-m.xyz
    port: 443
    type: vmess
    uuid: b4282c3f-4773-4fb2-a0a4-1d36ab6e099d
    alterId: 0
    cipher: auto
    tls: true
    skip-cert-verify: true
    ...
    ws-headers:
      Host: jp1.loc-m.xyz
    udp: true
  - name: 加拿大-3.75MB/s(Youtube:不良林)
    server: 168.138.94.194
    port: 443
    type: vmess

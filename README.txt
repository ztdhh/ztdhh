...
proxies:
  - name: 美国-5.45MB/s(Youtube:不良林)
    server: 104.233.191.182
    port: 443
    type: vmess
    ...
    network: ws
    ws-path: /path/031730091420
    ws-headers:
      Host: 104.233.191.182
    udp: true
  - name: US_114 |29.30Mb
    server: 13.213.34.54
    port: 443
...
proxy-groups:
  - name: 🔰 节点选择
    ...
    proxies:
      ...
      - ♻️ 自动选择
      - 🎯 全球直连
      - 美国-5.45MB/s(Youtube:不良林)
      - US_114 |29.30Mb
      - 美国-4.95MB/s(Youtube:不良林)
      - Youtube顺丰资源 美国
      - 荷兰-2.67MB/s(Youtube:不良林)
      - _02 | 4.44Mb

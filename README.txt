...
proxies:
  ...
  - {name: 中转节点-12.51MB/s(Youtube:不良林), server: relay1.wl-node1.com, port: 39001, type: vmess, uuid: dded6ef8-0bc4-4c84-98ec-8e74eba97b00, alterId: 0, cipher: auto, tls: false, skip-cert-verify: true, udp: true}
  ...
  - {name: 韩国-1.01MB/s(Youtube:不良林), server: 138.2.122.225, port: 443, type: vmess, uuid: 91646f9a-b4e9-4aca-bfe3-8892b3e58fe7, alterId: 0, cipher: auto, tls: true, skip-cert-verify: true, network: ws, ws-path: /ray, ws-headers: {Host: lg30.cfcdn3.xyz}, udp: true}
  - {name: 中转节点-6.02MB/s(Youtube:不良林), server: relay.wl-node1.com, port: 39002, type: ss, cipher: aes-128-gcm, password: dded6ef8-0bc4-4c84-98ec-8e74eba97b00, udp: true}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
      ...
      - 中转节点-12.51MB/s(Youtube:不良林)
      - 荷兰-1014.0KB/s(Youtube:不良林)
      - 韩国-1.01MB/s(Youtube:不良林)
      - 中转节点-6.02MB/s(Youtube:不良林)
  - name: ♻️ 自动选择
    type: url-test

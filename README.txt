...
proxies:
  - name: 中转节点-7.59MB/s
    server: mf66fx.micloud.buzz
    port: 42266
    type: vmess
    uuid: 83db123a-4294-49a0-b164-8addbf348b66
    alterId: 0
    cipher: auto
    tls: false
    ...
    ws-path: /zh-cn
    ws-headers:
      Host: mf66fx.micloud.buzz
    udp: true
  - name: 未知国家-971.9KB/s
    server: kansas.kotick.site
    port: 443
    type: vmess
  ...
  - name: 中转节点-8.28MB/s
    ...
    port: 39037
    type: vmess
    uuid: 518e0801-7191-3f9e-b6eb-728a6c2890ab
    alterId: 0
    cipher: auto
    tls: false
    skip-cert-verify: true
  ...
  - name: (已存活1天)中转节点-6.64MB/s
    ...
    udp: true
  - name: 中转节点-14.65MB/s
    server: a2jphkzxwmzjylmt.wudaki972.me
    port: 9541
    type: ss
    cipher: aes-128-gcm
    password: eFMBbL
  ...
  - name: 美国-2.56MB/s
    ...
    udp: true
  - name: (已存活1天)中转节点-1.99MB/s
    server: sg-04.xm1s.top
    port: 457
    type: ssr
    cipher: dummy
    password: UtFRxN
  ...
  - name: 中转节点-10.78MB/s
    ...
    obfs: http_simple
    protocol-param: 26552:FZmFn0
    obfs-param: 3355f26552.microsoft.com
    udp: true
  ...
  - name: 中转节点-1.78MB/s
    ...
    password: 956e5797-bf54-414f-80bc-5a896f3a553d
    udp: true
  - name: 美国-2.28MB/s
    server: 104.31.16.3
    port: 2087
    ...
    grpc-opts:
      grpc-service-name: fffffffstrrrrryyyyhhhhsnnnkakkkkdllllssasdf
    udp: true
  - name: 韩国-475.9KB/s
    server: 43.201.61.124
    port: 443
    type: ss
    cipher: aes-256-cfb
    password: amazonskr05
